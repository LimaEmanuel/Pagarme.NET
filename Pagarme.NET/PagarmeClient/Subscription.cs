...
namespace PagarmeClient
{
    public class Subscription : Base.Model
    {
        ...
        protected override PagarmeClient.Base.NestedModelSerializationRule SerializationRuleForField(string field, Base.SerializationType type)
        {
            if (field == "customer" && type != Base.SerializationType.Shallow)
                return PagarmeClient.Base.NestedModelSerializationRule.Full;
